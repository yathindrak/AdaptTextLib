...
class AdaptText:
    ...
    def build_classifier(self, df, text_name, label_name, grad_unfreeze: bool = True, preprocessor=None):
        ...
        df_trn, df_val = train_test_split(df, stratify=df[label_name], test_size=0.1, random_state=1)
        ...
        ensembleTrainer = EnsembleTrainer(classifierModelFWD, classifierModelBWD, classes, is_imbalanced=self.is_imbalanced)
