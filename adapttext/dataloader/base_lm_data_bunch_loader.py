...
class BaseLMDataBunchLoader(BaseDataBunchLoader):
    ...
    def load(self):
        ...
        data = (TextList.from_folder(Path(self.path), processor=[OpenFileProcessor(), TokenizeProcessor(tokenizer=tokenizer, chunksize=5000), NumericalizeProcessor(max_vocab=30000)])
